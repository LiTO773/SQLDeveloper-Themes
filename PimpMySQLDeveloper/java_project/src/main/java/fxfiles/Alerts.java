...
public class Alerts {
    ...
    public static boolean invalidateDtCache() {
        ...
        alert.setHeaderText("READ THE INSTRUCTIONS BELOW");
        alert.setContentText("You're about to reset your color schemes. Don't worry, this will only reset your color schemes. After clicking 'OK' do the following steps:\n" +
                " - Open SQLDeveloper\n" +
                " - Close SQLDeveloper\n" +
